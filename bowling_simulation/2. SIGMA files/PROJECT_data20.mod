...
Model Name:         PROJECT_data20.mod
Model Description:  BOWLING ALLEY
Output File:        PROJECT_data20.OUT
...
Random Number Seed: 44597
Initial Values:     0,20,0,0,0,0,0,0,0,0
...
State Changes:    L[CLK/60-24*(DAY-1)]=L[CLK/60-24*(DAY-1)]+(20-S)
Parameter(s):     
Bitmap(Inactive): 
Bitmap(Active):   
Use Flowchart Shapes:   0
Use Opaque Bitmaps:   0
Location:         X:  0.17;  Y:  1.85;  Z: -1.00;
