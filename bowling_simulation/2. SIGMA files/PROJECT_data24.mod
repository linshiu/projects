...
Model Name:         PROJECT_data24.mod
Model Description:  BOWLING ALLEY
Output File:        PROJECT_data24.OUT
...
Initial Values:     0,24,0,0,0,0,0,0,0,0
...
State Changes:    L[CLK/60-24*(DAY-1)]=L[CLK/60-24*(DAY-1)]+(24-S)
Parameter(s):     
Bitmap(Inactive): 
Bitmap(Active):   
Use Flowchart Shapes:   0
Use Opaque Bitmaps:   0
Location:         X:  0.16;  Y:  1.85;  Z: -1.00;
