...
Model Name:         PROJECT_data_7.mod
Model Description:  BOWLING ALLEY
Output File:        PROJECT_data_7.OUT
Output Plot Style:  NONE
Run Mode:           HI_SPEED
Trace Vars:         B,N,C
Random Number Seed: 12345
Initial Values:     0,26,0,0,0,0,0,0,0,0
...
State Changes:    S=C
Parameter(s):     Q,C,B,AI,SI,DAY,WDAY,WAIT,N,CTIME
Bitmap(Inactive): 
Bitmap(Active):   
