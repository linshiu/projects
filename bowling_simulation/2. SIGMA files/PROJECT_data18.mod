...
Model Name:         PROJECT_data18.mod
Model Description:  BOWLING ALLEY
Output File:        PROJECT_data18.OUT
...
Initial Values:     0,18,0,0,0,0,0,0,0,0
...
State Changes:    L[CLK/60-24*(DAY-1)]=L[CLK/60-24*(DAY-1)]+(18-S)
Parameter(s):     
Bitmap(Inactive): 
Bitmap(Active):   
Use Flowchart Shapes:   0
