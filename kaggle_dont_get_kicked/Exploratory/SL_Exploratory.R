...
numLevels = sapply(mydata[,i],nlevels)
barplot(sapply(mydata[,i],nlevels))

resp = "IsBadBuy"

var_cont = c("VehYear", "VehicleAge","VehOdo", "MMRAcquisitionAuctionAveragePrice",
